						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Message" type="text" placeholder="Enter Message" v-model="customerSupportToAdd.message"></base-input>
								  <base-input label="ResponseDate" type="text" placeholder="Enter ResponseDate" v-model="customerSupportToAdd.responseDate"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Message</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Message" type="text" placeholder="Enter Message" v-model="customerSupportDetails.message"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Response Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="customerSupportDetails.responseDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
