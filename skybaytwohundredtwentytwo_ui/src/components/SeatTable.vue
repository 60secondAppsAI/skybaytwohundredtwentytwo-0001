...
<template>
  ...
  <base-input label="SeatClass" type="text" placeholder="Enter SeatClass" v-model="seatToAdd.seatClass"></base-input>
  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'seatClass',
          visible: true,
          scopedSlots: { customRender: 'seatClass' },
          sorter: true
          //sorter: (a, b) => a.seatClass - b.seatClass,
