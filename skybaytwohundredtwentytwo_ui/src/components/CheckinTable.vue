...
<template>
  ...
  <base-input label="CounterNumber" type="text" placeholder="Enter CounterNumber" v-model="checkinToAdd.counterNumber"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'counterNumber',
          visible: true,
          scopedSlots: { customRender: 'counterNumber' },
          sorter: true
          //sorter: (a, b) => a.counterNumber - b.counterNumber,
          //sorter: (a, b) => a.counterNumber.localeCompare(b.counterNumber),
        },
      ],
      pagination: {
        current: 1,
